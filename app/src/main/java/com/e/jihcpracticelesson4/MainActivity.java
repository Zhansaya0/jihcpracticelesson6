...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tv_print_san, tv_zapis;
    String firstNumber, secondNumber, znak, zapisText;
    ...
    public void PlusMinusCleanMethods(){
    ...
    public void functionMethods(){
        ...
        public void onClick(View v) {
            firstNumber = tv_print_san.getText().toString();
            switch (v.getId()){
                case R.id.btnPlus:
                    znak = "+";
                    break;
        ...
        btnDivision.setOnClickListener(btnFunctions);

        btnEqual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                secondNumber = tv_print_san.getText().toString();
                int san1 = Integer.parseInt(firstNumber);
                int san2 = Integer.parseInt(secondNumber);
                int res = 0;
                if(znak.equals("+")){
                    res = san1 + san2;
                }else if(znak.equals("-")){
                ...
                zapisText = firstNumber + znak + secondNumber + "=" + res;
                tv_zapis.setText(zapisText);
                tv_print_san.setText(""+res);
            }
        });
    }
}